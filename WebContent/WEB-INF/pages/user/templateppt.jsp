...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Template Pptx</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-default">
				<div class="panel-heading">Template Pptx List</div>
				<!-- /.panel-heading -->
		...
		<div class="col-lg-4">
			<div class="panel panel-default">
				<div class="panel-heading">Upload Template Pptx</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
...
<script src="<c:url value='assets/js/template-ppt-script.js'/>"></script>
