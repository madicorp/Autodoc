...
import net.madicorp.autodoc.filemanager.data.EventArgs;
import net.madicorp.autodoc.filemanager.data.EventCommandData;
import net.madicorp.autodoc.filemanager.data.IEventHandler;
