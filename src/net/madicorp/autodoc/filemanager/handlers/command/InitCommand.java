...
import net.madicorp.autodoc.filemanager.data.InitCommandEventArgs;
import net.madicorp.autodoc.filemanager.data.PluginInfo;
...
import net.madicorp.autodoc.filemanager.utils.PathUtils;
