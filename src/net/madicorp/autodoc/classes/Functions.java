...
public class Functions {
  ...
  protected boolean term;
	...
	*/
	public boolean generateDocument(String textFilePath, String templatePath,
	String targetName)
	{
	   ...
	   //progress scrollbar
		...
		//.DOCX
		if ( extension.equals(".docx") || extension.equals(".docm")  || extension.equals(".dotx") || extension.equals(".dotm"))
		{
				is_success = this.generateDOCX(textFilePath, templatePath);
		}

		//.PPTX
		if ( extension.equals(".pptx") ||  extension.equals(".potx") )
		{
			is_success = this.generatePPTX(textFilePath, templatePath);
		}

		//.XLSX
		if ( extension.equals(".xlsx") || extension.equals(".xlsm") || extension.equals(".xltx") || extension.equals(".xltm"))
		{ 
...
*/
	...
	*/
	...
	{
		if (t.endsWith(".docx") || t.endsWith(".docm")  || t.endsWith(".dotx") || t.endsWith(".dotm") || 
			t.endsWith(".pptx") || t.endsWith(".potx")  || 
			t.endsWith(".xlsx") || t.endsWith(".xlsm") || t.endsWith(".xltx") || t.endsWith(".xltm")) 
			
		{
			this.targetName = t.substring(0, t.lastIndexOf('.'));
			if (targetName.endsWith(".docx") || targetName.endsWith(".docm")   || targetName.endsWith(".dotx") || targetName.endsWith(".dotm") || 
				targetName.endsWith(".pptx") || targetName.endsWith(".potx")   || 
				targetName.endsWith(".xlsx") || targetName.endsWith(".xlsm")   || targetName.endsWith(".xltx") || targetName.endsWith(".xltm"))
			{
	...
	*/
	protected boolean generateDOCX(String textFilePath, String templatePath)
	{
		...
		try
		{
			...
			//SAVE THE FILE
			templateFile.save(new java.io.File(targetName+extension));
	...
	*/
	protected boolean generatePPTX(String textFilePath, String templatePath){
		...
		try
		{
			...
			//SAVE FILE
			pptMLPackage.save(new java.io.File(this.targetName+extension) );
			is_success = true;
		}
		catch (Docx4JException e){
			debugger("DOCX4JERROR");
	...
	protected boolean generateXLSX(String textFilePath, String templatePath){
		...
		try
		{
		  ...
		  removeXLSXFormulaValues();
			...
			//SAVE IT
			xlsMLPackage.save(new java.io.File(this.targetName+extension) );
			is_success = true;
		}
		catch ( Docx4JException e )
		{
	...
	*/
	protected boolean replaceInit(String bookmark, String value)
	{
		boolean success = true;
			//DOCX
		if ( extension.equals(".docx") || extension.equals(".docm") || extension.equals(".doc") || extension.equals(".dot") || extension.equals(".dotx") || extension.equals(".dotm") )
		{
